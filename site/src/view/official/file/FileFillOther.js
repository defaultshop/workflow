...
export default {
  ...
  data() {
    return {
      ...
      residencePermitBookFather: "",
      residencePermitBookMother: ""
    };
  },
  async created() {
    ...
    if (res.success) {
      if (res.result.bookIsFill) {
        ...
        this.residencePermitBookFather = res.result.residencePermitBookFather;
        this.residencePermitBookMother = res.result.residencePermitBookMother;
      }
    }
  },
  methods: {
    uploadSuccess(id, i) {
      ...
      if (i === 6) this.residencePermitBookFather = id.join();
      if (i === 7) this.residencePermitBookMother = id.join();
    },
    ...
    async submitInfo() {
      ...
      let res = await res_repay.post_AddBookInfo({
        ...
        residencePermitBookFather: this.residencePermitBookFather,
        residencePermitBookMother: this.residencePermitBookMother,
        schoolRegisterType: sessionStorage.getItem("schoolRegisterType"),
        businessType: sessionStorage.getItem("businessTypes")
      });
      if (res.success) {
