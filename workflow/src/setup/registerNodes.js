...
const cosutomNodes = [
  ...
  // [intermediateMessageThrowEvent, 'bpmn:Inte     rmediateThrowEvent', 'bpmn:MessageEventDefinition'],
...
export default function registerNodes({ registerNode, registerBpmnExtension }) {
  cosutomNodes.forEach(([nodeType, primaryIdentifier, secondaryIdentifier]) => {
